...
class BaseDataSample(object):
    ...
    def __repr__(self):
        return u'Input: {},Features: {}, Output: {}, Features: {}, Wraps: {}'.format(self.lemma_str,
    ...
    def from_row(cls, vocab, training_data, tag_wraps, verbose, row, sigm2017format=True,
        ...
        assert isinstance(output_str, unicode), output_str
        assert not any(c in output_str for c in SPECIAL_CHARS), (output_str, SPECIAL_CHARS)
        assert isinstance(in_feats_str, unicode), in_feats_str
        ...
        if verbose == 2:
            ...
            print u'POS & features from {}, {}: {}, {} --> {}, {}'.format(input_str, output_str, in_pos, in_feats, out_pos, out_feats)
            print u'input encoding: {}'.format(input)
...
class PCFPDataSample(object):
    ...
    def from_row(cls, vocab, training_data, tag_wraps, verbose, list_of_rows, sigm2017format=True,
        ...
        for row in list_of_rows:
            ...
            if verbose == 2:
                # print u'POS & features from {}, {}, {}: {}, {}'.format(feat_str, output_str, input_str, pos, feats)
                print u'POS & features from {}, {}: {}, {} --> {}, {}'.format(input_str, output_str, in_pos, in_feats,
                                                                        out_pos, out_feats)
                print u'input encoding: {}'.format(input)
